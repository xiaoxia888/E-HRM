...
def test_cancelled_task_writes_result_for_every_unprocessed_person(
    ...
    records = (
        EmployeeRecord(2, "测试单位", "信息部", "张三", "320101199001011234", "养老", "2025-01", "2025-06", "RLSQ20260819-0001"),
        EmployeeRecord(3, "测试单位", "人事部", "李四", "320101199002021235", "养老", "2025-01", "2025-06", "RLSQ20260819-0001"),
    )
    ...
    try:
        assert exported.active.cell(2, 9).value == "用户提前停止任务"
        assert exported.active.cell(3, 9).value == "用户提前停止任务"
    finally:
        exported.close()
